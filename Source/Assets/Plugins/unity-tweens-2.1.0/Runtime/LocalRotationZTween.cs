...
namespace ElRaccoone.Tweens
{
	public static class LocalRotationZTween
	{
		...
		private class Driver : Tween<float, Transform>
		{
			...
			{
				this.quaternionValueFrom =
					Quaternion.Euler(this.component.localEulerAngles.x, this.component.localEulerAngles.y, this.valueFrom);
				this.quaternionValueTo =
					Quaternion.Euler(this.component.localEulerAngles.x, this.component.localEulerAngles.y, this.valueTo);
