...
namespace ElRaccoone.Tweens.Core
{
	...
	public abstract class Tween<DriverValueType> : MonoBehaviour, ITween
	{
		...
		public bool IsStarted => didTriggerOnStart;
		...
		private void Update()
		{
			...
			{
				this.delay -= this.useUnscaledTime ? Time.unscaledDeltaTime : Time.unscaledDeltaTime * ITween.TweenScaleDeltaTime;
				if (this.delay <= 0)
				{
					this.hasDelay = false;
			...
			else
			{
				...
				var _timeDelta = (this.useUnscaledTime ? Time.unscaledDeltaTime : Time.unscaledDeltaTime * ITween.TweenScaleDeltaTime) /
				                 this.duration;
		...
		/// <returns>The current Tween.</returns>
		public Tween<DriverValueType> UseUnscaledTime(bool useUnscaledTime)
		{
			this.useUnscaledTime = useUnscaledTime;
			return this;
		}

		public Tween<DriverValueType> UseScaledTime(bool useScaledTime = true)
		{
			this.useUnscaledTime = !useScaledTime;
			return this;
		}
