		...
		private class Driver : Tween<float, Transform>
		{
			...
			public override void OnUpdate(float easedTime)
			{
				this.quaternionValueFrom =
					Quaternion.Euler(this.valueFrom, this.component.localEulerAngles.y, this.component.localEulerAngles.z);
				this.quaternionValueTo =
					Quaternion.Euler(this.valueTo, this.component.localEulerAngles.y, this.component.localEulerAngles.z);
