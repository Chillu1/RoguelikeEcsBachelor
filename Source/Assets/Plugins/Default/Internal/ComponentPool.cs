...
{
    public sealed class ComponentPool<T> : ISortable
    {
        #region Types
        ...
        private static void ThrowMaxNumberOfComponentReached() =>
        ...
        public int GetIndex(int entityId)
        {
            ////TODO Remove check
            //if (_isFlagType)
            //	UnityEngine.Debug.LogError("Trying to get index of flag component (always 0): " + typeof(T).Name);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ReadOnlySpan<T> AsReadOnlySpan() => new(_components, 0, _lastComponentIndex + 1);
